...
pub struct HandoffDocument {
    ...
    /// Optional: report generated by documenter agent
    #[serde(skip_serializing_if = "Option::is_none")]
    pub generated_report: Option<ReportReference>,

    /// Set by architect if architecture changes were introduced
    #[serde(skip_serializing_if = "Option::is_none")]
    pub arch_change_flag: Option<bool>,

    /// If arch_change_flag is true, architect provides description
    #[serde(skip_serializing_if = "Option::is_none")]
...
/// Optional report generation metadata.
/// Set by documenter agent when a report is created.
#[derive(Debug, Clone, Serialize, Deserialize)]
